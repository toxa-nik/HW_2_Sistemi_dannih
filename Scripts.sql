...
-- У меня получилось 1 клиента с 7 заказами и 12 клиент с 5 заказами, 
-- и, чтобы выбрать оставшиеся 9 клиентов (из 12 с 5 заказами), я отобрал первых 9 с наименьшим customer_id.
